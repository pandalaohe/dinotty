...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'settings.plugins.installGit': 'Install from Git URL',
    'settings.plugins.gitPlaceholder': 'owner/repo or full GitHub URL',
  ...
  zh: {
    ...
    'settings.plugins.installGit': '从 Git URL 安装',
    'settings.plugins.gitPlaceholder': 'owner/repo 或完整 GitHub URL',
