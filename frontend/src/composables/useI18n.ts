...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'settings.confirmBeforeCloseTabHint':
      'Show a confirmation dialog before closing a terminal tab that may be running an AI agent',
    'settings.behavior': 'Behavior',
    'confirm.closeTabTitle': 'Close session?',
    'confirm.closeTabMessage': 'This session may be running an AI agent. Close',
  ...
  zh: {
    ...
    'confirm.closeTabMessage': '当前会话可能正在运行 AI 代理。确定关闭',
