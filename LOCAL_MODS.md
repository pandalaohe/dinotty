...
- Currently aligned to `upstream/dev@beb9e30` (`2026-08-27`, custom HEAD `0cf7a26`) by MERGE on top of
  that rebuild baseline; `behind=0`, `ahead=29`. Backup tag taken before this merge:
  `pre-update-custom-20260827-105057`.
