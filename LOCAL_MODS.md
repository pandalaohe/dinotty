...
| `epv1-preview-freeze-annotate` | maybe | | | candidate | pending | | open — v1 freeze/annotate/export on kind=web pane (frontend-only: WebPreview.vue + WebAnnotationLayer.vue + previewImage.ts + i18n + snapdom dep); upstream PR candidacy decided post-E2E per design T260723-028 |
